...
class AppSettings(BaseSettings):
    ...
    # Dynamo
    DYNAMO_USER_TABLE_NAME: str = os.environ.get(
        "DYNAMO_USER_TABLE_NAME", "geo_poc_user"
    )
    DYNAMO_FEATURES_TABLE_NAME: str = os.environ.get(
        "DYNAMO_FEATURES_TABLE_NAME", "geo_poc_feature"
    )
